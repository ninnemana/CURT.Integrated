 ...
 *
 */
public class ConfigrStyle extends ListActivity {
	...
	public String mount, year, make, model, style;
	...
	public class YearRunner implements Runnable{
		public void run(){
			...
			String history = config.getDisplayableMount() + " " + config.getYear() + " " + config.getMake() + " " + config.getModel();
			...
			adapter = new ArrayAdapter<String>(ConfigrStyle.this, R.layout.lookup_list_row, R.id.lookup_option,options);
			...
			listView.setOnItemClickListener(new OnItemClickListener(){
				...
				public void onItemClick(AdapterView<?> parent, View view,
						int pos, long id) {
					style = (String) parent.getItemAtPosition(pos);
